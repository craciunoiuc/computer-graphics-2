...
class ParticleEffect
{
	public:
		...
		virtual void Render(Camera* camera, Shader* shader, glm::mat4 modelMatrix, unsigned int nrParticles = -1);
...
template <class T>
void ParticleEffect<T>::Render(Camera *camera, Shader *shader, glm::mat4 modelMatrix, unsigned int nrParticles)
{
	// Bind MVP
